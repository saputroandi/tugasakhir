...
<div class="flex flex-col w-full h-full my-10 justify-center items-center">
  ...
  <div class="md:flex md:justify-center w-11/12 h-3/5 my-5 md:my-0 overflow-auto">

    <div class="w-21cm md:my-5 bg-white layout-surat font-surat">
      ...
      <div class="flex flex-col p-2.54cm">
        ...
        <div class="flex w-full justify-between">
          ...
          <div class="flex flex-col flex-grow items-center">
            ...
            <p class="mb-7 p-1 border-2 border-black">materai</p>
