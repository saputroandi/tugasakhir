        ...
        <div class="flex flex-col w-full p-4 bg-buatbody rounded gap-3">
          ...
          <div class="flex w-full hover:bg-buatbgkomponen rounded">
            ...
            <div class="flex flex-col justify-center p-2 w-1/3">
              <p class="font-semibold text-xl">Andi s</p>
              <p class="font-light text-sm">andi@gmail.com</p>
            </div>
          ...
          <div class="flex w-full hover:bg-buatbgkomponen rounded">
            ...
            <div class="flex flex-col justify-center p-2 w-1/3">
              <p class="font-semibold text-xl">Bambang p</p>
              <p class="font-light text-sm">bambang12@gmail.co.id</p>
            </div>
            <div class="flex justify-center items-center p-2 w-1/3 gap-3">
              <a href="#" class="p-3 rounded bg-red-500">Hapus</a>
            </div>
          ...
          <div class="flex w-full hover:bg-buatbgkomponen rounded">
            ...
            <div class="flex flex-col justify-center p-2 w-1/3">
              <p class="font-semibold text-xl">sinyo</p>
              <p class="font-light text-sm">sinyo@rcketmail.com</p>
            </div>
            <div class="flex justify-center items-center p-2 w-1/3 gap-3">
              <a href="#" class="p-3 rounded bg-red-500">Hapus</a>
            </div>
