...
<div class="flex w-full justify-center items-center">
  <div class="flex flex-col p-4 my-5 w-10/12 bg-buatbgkomponen gap-2 rounded-md">
    <p class="text-center font-medium text-3xl">Edit Surat Permohonan Maaf</p>
    <form action="{{ '/'.$slugSurat.'/'.$order->order_id }}" method="post">
      ...
      @csrf
        ...
        <div class="mx-8 mb-1">
          ...
          <input type="text" name="nama_spm" id="nama_spm" class="w-full p-2 border-2 border-buatborder bg-buatbody rounded " placeholder="Mawar" value="{{ $spm->nama_spm }}">
        ...
        <div class="mx-8 mb-1 w-full p-2">
          <input type="radio" name="jns_klm_spm" id="jns_klm_penerima_sk_pria" value="pria" {{ $spm->jns_klm_spm == "pria" ? "checked" : "" }}>
          <label for="jns_klm_penerima_sk_pria">Pria</label>
          <input type="radio" name="jns_klm_spm" id="jns_klm_penerima_sk_wanita" value="wanita" {{ $spm->jns_klm_spm == "wanita" ? "checked" : "" }}>
          <label for="jns_klm_penerima_sk_wanita">Wanita</label>
        </div>

        <div class="mx-8 mb-1">
          <label for="alamat_spm">Alamat</label>
          <input type="text" name="alamat_spm" id="alamat_spm" class="w-full p-2 border-2 border-buatborder bg-buatbody rounded" placeholder="Jl. Pandu No.1 Rt.001/001 Cikini, Jakarta Pusat, DKI Jakarta." value="{{ $spm->alamat_spm }}">
        ...
        <div class="mx-8 mb-1">
          ...
          placeholder="Programmer PT. Gelora" value="{{ $spm->pekerjaan_spm }}">
        ...
        <div class="mx-8 mb-1">
          ...
          placeholder="Mencuri ayam" value="{{ $spm->kesalahan_spm }}">
        ...
        <div class="mx-8 mb-1">
          ...
          placeholder="Bambang" value="{{ $spm->penerima_spm }}">
        ...
        <div class="flex gap-2 mx-8 mb-2">
          <div class="w-1/2">
            ...
            placeholder="Jakarta" value="{{ $spm->tmpt_spm_terbit }}">
          ...
          <div class="w-1/2">
            ...
            <input type="date" name="tgl_spm_terbit" id="tgl_spm_terbit" class="w-full p-2 border-2 border-buatborder bg-buatbody rounded " value="{{ $spm->tgl_spm_terbit }}">
